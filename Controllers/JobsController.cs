...
namespace Repository.Controllers
{
    public class JobsController : Controller
    {
        ...
        {
            var jobs = db.Jobs.Include(j => j.tbl_Locations);
        ...
        {
            ViewBag.LocationID = new SelectList(db.tbl_Locations, "LocationID", "LocationName");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "JobID,CompanyName,Details,Designation,LocationID,Number_of_Positions")] Job job)
        {
            if (ModelState.IsValid)
            {
